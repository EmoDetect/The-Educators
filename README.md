...
- *Access between pages without authentification required at this phase* ✔️

#### [Version 1] ####
- Game implementation; ✔️
- Implement access through webcam feature; ✔️
- Capture a photo during the gameplay and save it in database; ✔️
- Identify the emotions from the taken screenshot and save them in database; ✔️

#### [Version 2] ####
-  Login & Register implementation; ✔️
-  Add default login credentials for educators; ✔️
-  Link data in the entire web application(between pages); ✔️
